...
def create_matlab_call(path):
    ...
    for i in filedict.keys():
        ...
        matlab_call= '/opt/local/MATLAB/R2016b/bin/matlab -nodisplay -nosplash -nodesktop -noFigureWindows -r \"addpath(genpath(\'/home/mheydasch/Scripts/neuritetracker-master1/trunk\'));  {}'.format(function_call)
